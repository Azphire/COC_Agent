...
class RuleTopicRegistry:
    ...
    topics = (
        RuleTopic(
            "coc7.opposed_check", ("对抗", "对抗检定", "平局", "僵局"), (78, 79, 80), "5.7–5.8",
            "非战斗双方声明互斥目标，使用各自属性或技能",
            "双方比成功等级，同级比完整数值，完全平局首版为僵局；不能孤注。",
        ),
        RuleTopic(
            "coc7.combined_check", ("组合", "组合检定", "组合技能检定"), (80,), "5.9",
            "同一角色的两个技能，共用一次百分骰",
            "分别比较两项技能；KP在掷骰前指定任一或全部成功。幸运和孤注作用于整次尝试。",
        ),
        RuleTopic(
            "coc7.skill_check",
            ("技能检定", "属性检定", "侦查", "检定"),
