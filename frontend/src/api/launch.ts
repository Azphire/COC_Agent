...
export type LaunchDocument = { preparation_id: string; character_id?: string | null; party_batch_id?: string | null; name?: string; rules?: RuleReference[]; handout_acknowledged?: boolean; acknowledge_unspent?: boolean }
