...
职业点按条目采用 EDU×4 或 EDU×2＋指定／所选属性×2，兴趣点为 INT×2，分别记账；技能值为基础值加两类投入。信用评级须满足职业范围，母语基础值为EDU，闪避为DEX半值，职业／兴趣点禁止购买克苏鲁神话；神秘学家可经KP许可独立获得初始值。未分配技能点在确认时放弃。当前不启用75技能上限、属性重骰、经历包等其他可选方案；没有逐项重骰入口。
...
普通手册职业数值块已有映射；动物特殊裁定、经历包及其他专业替换继续列在覆盖表的具体剩余清单。尚未支持90岁及以上条款、自定义格斗／射击、跨专业可选加值，以及自动射击、霰弹分档、爆炸范围、链锯／绞索等武器特例。目录与来源见 [SOURCES.md](backend/app/rules/definitions/SOURCES.md)。
