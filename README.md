...
刷新页面或重启后可继续读取草稿和确认后的角色，保留原始骰。旧 1.0.0、1.1.0、1.2.0 规则均已归档；旧草稿继续按原版编辑，旧卡导入按原版校验，旧确认卡和房间快照不迁移重算。
...
普通手册职业数值块已有映射；动物特殊裁定、神话经历包／法术及其他专业替换继续列在覆盖表的具体剩余清单。尚未支持90岁及以上条款、自定义格斗／射击、跨专业可选加值，以及自动射击、霰弹分档、爆炸范围、链锯／绞索等武器特例。目录与来源见 [SOURCES.md](backend/app/rules/definitions/SOURCES.md)。
